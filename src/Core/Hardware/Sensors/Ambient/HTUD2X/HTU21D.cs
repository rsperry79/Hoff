...
//namespace Hoff.Hardware.Sensors.Temperature
//{
...
//    /// </summary>
//    public class HTU21D : AbstractSensor, IHTU21D, IAbstractSensor
//    {
...
//        public HTU21D(int busSelector = 1, byte deviceAddr = 0x40, I2cBusSpeed speed = I2cBusSpeed.StandardMode,
//            uint scale = 2)
//        {

//            I2cConnectionSettings i2cSetttings = new I2cConnectionSettings(busSelector, deviceAddr, speed);
...
//        private bool IsCRCValid(ushort sensorValue, byte crc)
//        {
